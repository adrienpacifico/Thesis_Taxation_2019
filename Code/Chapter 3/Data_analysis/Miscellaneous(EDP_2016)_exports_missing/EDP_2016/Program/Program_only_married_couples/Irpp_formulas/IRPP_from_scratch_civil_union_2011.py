...
rates = np.array([0,0.055, 0.14, 0.3, 0.41]) #To modify for specific year 2014
thresholds = [0,5963,11896,26420, 70830]  #To modify for specific year 2014
...
def ir_sans_qf(rni=None, thresholds=thresholds, rates=rates):#times 2 for civil union
    '''
    Impôt sans quotient familial
    '''
    rni = rni/2
    return calc(rni, thresholds, rates)*2
...
def ir_avec_plafond_qf_enfant(rni=None, parts_fiscales_enfant = None, thresholds= thresholds, rates = rates):
    ...
    qf_threshold = (parts_fiscales_enfant) * 2336*2  #To modify for specific year 2014
    ir_plaf_qf = (
        (
...
class abatpro:
    max = 14157 #To modify for specific year 2014
    min = 421 #To modify for specific year 2014
...
class abatpen:
    min = 368 #To modify for specific year 2014
    max = 3660 #To modify for specific year 2014
